const socialLinks = [
    ...
    {
      href: 'https://www.linkedin.com/in/imal-udayanga-b13631269', // Link එකේ තිබ්බ අමතර tracking code ටික අයින් කරලා පිරිසිදු කලා
      icon: <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <section id="contact" className="section">
        <div className="container lg:grid lg:grid-cols-2 lg:items-stretch">
            <div className="mb-12 lg:mb-0 lg:flex lg:flex-col">
                ...
                <p className="text-zinc-400 mt-3 mb-6 max-w-[50ch] lg:max-w-[30ch] reveal-up">
                Reach out today to discuss your project needs and start collaborating on something amazing!
                </p>

                {/* අලුතෙන් දැම්ම Phone & Email කොටස */}
                <div className="flex flex-col gap-3 mb-8 reveal-up">
                    <a href="mailto:imaludayanga6@gmail.com" className="flex items-center gap-3 text-zinc-400 hover:text-sky-400 transition-colors w-max">
                        <span className="material-symbols-rounded" aria-hidden="true">mail</span>
                        imaludayanga6@gmail.com
                    </a>
                    <a href="tel:+94712841611" className="flex items-center gap-3 text-zinc-400 hover:text-sky-400 transition-colors w-max">
            ...
            <form action="https://getform.io/f/aroopneb" method="POST" className="xl:pl-10 2xl:pl-20">
