const socialLinks = [
  ...
  {
    href: 'https://x.com/imal_udayanga',
    icon: (
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  {
    href: 'https://www.instagram.com/imal_udayanga6',
    icon: (
    ...
    <section id="contact" className="section">
      <div className="container lg:grid lg:grid-cols-2 lg:items-stretch">
        <div className="mb-12 lg:mb-0 lg:flex lg:flex-col">
          <h2 className="contact-title headline-2 lg:max-w-[12ch] reveal-up">
            Contact me for collaboration
          </h2>

          <p className="contact-description mt-3 mb-6 max-w-[50ch] lg:max-w-[30ch] reveal-up">
            Reach out today to discuss your project needs and start
            collaborating on something amazing!
          </p>

          <div className="contact-info-list flex flex-col gap-3 mb-8 reveal-up">
            <a href="mailto:imaludayanga6@gmail.com" className="contact-info-link">
            ...
            <a href="tel:+94712841611" className="contact-info-link">
              <span className="material-symbols-rounded" aria-hidden="true">
                call
              </span>
              +94 71 28 41611
          ...
          <div className="contact-social-list flex items-center gap-2 mt-auto">
            {socialLinks.map(({ href, icon, alt }, key) => (
              <a
                ...
                className="contact-social-link reveal-up"
                aria-label={alt}
              >
                {icon}
              </a>
        ...
        <form
          ...
          method="POST"
          className="contact-form xl:pl-10 2xl:pl-20"
        >
          <div className="md:grid md:items-center md:grid-cols-2 md:gap-2">
            <div className="mb-4">
              <label htmlFor="name" className="contact-label reveal-up">
                Name
              </label>
              ...
              <input
                ...
                id="name"
                name="name"
                className="contact-text-field reveal-up"
                autoComplete="name"
                required
                placeholder="Imal Udayanga"
              />
            </div>

            <div className="mb-4">
              <label htmlFor="email" className="contact-label reveal-up">
                Email
              </label>
              ...
              <input
                ...
                autoComplete="email"
                required
                placeholder="imaludayanga@gmail.com"
              />
            </div>
          </div>

          <div className="mb-4">
            <label htmlFor="message" className="contact-label reveal-up">
              Message
            </label>
            ...
            <textarea
              name="message"
              id="message"
              className="contact-text-field resize-y min-h-32 max-h-80 reveal-up"
              required
